...
const CASES = [
  ...
  ['我是和猫',    '我/s 是/c 和/c 猫/o',        false, '是后「和猫」病句,判断句表语只能一个主体'],
  ...
  // 判断句收紧(真·实战 fuzzer 暴露):
  ['是猫',        '是/c 猫/o',                   false, '系词无主语,「是猫」没头'],
  ['是猫纸鬼',    '是/c 猫/s 纸鬼/T',           false, '系词后俩名词堆砌'],
  ['我是猫纸鬼',  '我/s 是/c 猫/s 纸鬼/o',      false, '表语过多(是后只能一个主体)'],
  ...
  // 仍放行的合法短式:
  ['碎砍',        '碎/v 砍/v',                   false, '裸双动词无主无宾,垃圾(收紧)'],
  ['我碎砍',      '我/s 碎/v 砍/v',             true,  '连动有主语'],
  ['碎砍月',      '碎/v 砍/v 月亮/o',           true,  '连动有宾语'],
