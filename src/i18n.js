...
const UI_STRINGS = {
  zh: {
    title: '词灵录',
    subtitle: '放学后，不要朗读墙上的字',
    startBtn: '进入旧校舍',
    metaBtn: '学生档案',
    credit: '林夕 · 高二（3）班 · 失联中',
    chant: '发行文字',
    endTurn: '等待铃声',
    deckBtn: '词库',
    energy: '文力',
  ...
  en: {
    ...
    subtitle: 'After school, never read the words on the wall',
    startBtn: 'Enter Old Campus',
    metaBtn: 'Student File',
    credit: 'Lin Xi · Class 2-3 · Missing',
    chant: 'Release Words',
    endTurn: 'Wait for Bell',
    deckBtn: 'Deck',
    energy: 'Ink',
    draw: 'Draw',
    discard: 'Disc',
    poemBook: 'Class Log',
    poet: 'Lin Xi',
    roundJournal: 'Anomalous Lines',
    notChanted: 'Nothing released…',
    enemy: 'Anomaly',
    me: 'I',
    victory: 'Anomaly Contained',
