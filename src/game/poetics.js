...
const RHYME_GROUPS = {
  // -a / -ia / -ua
  a: '啊吧爸把妈麻马骂他她它大花家话下夏麻沙萨打卡哈巴吗吧妈呀呐拿啦娃挂瓜画家加价假驾架嘉夸花化滑侠杀',
  // -e / -ie / -ue (蛇韵)
  e: '德格客喝乐了么呢色舍这者哲遮车扯歌哥河喝鹅恶饿和合何科可的而',
  // -i (衣韵, including zhi/chi/shi/ri/zi/ci/si as "ï")
  i: '一衣以已意忆易益亿七西气起齐其奇期理力丽利里立例你尼泥逆迷米密蜜技几纪计记济寄替体提题题谁是事时十时持知之直只指志智字此次思死师诗史使始事示士市世式视试饰己日底逼击屁地失瓷子帝溺棘壁',
  // -u (呜韵)
  u: '不步部布父父母目木目都读独度毒度肚怒努路鲁卢露虎户互护户图涂土吐塗书输熟猪住助主珠柱注组祖足族苦哭酷库兔物湖谱屋夫补诛骨呼',
  // -ü (鱼韵)
  v: '鱼语雨女予余于雩雩雩遇玉欲虚需须许去趣取曲屈居举句具据距聚续蓄须叙绪',
  // -ai (开韵)
  ai: '爱哀挨百白拜败排牌派来赖蓝才材财采菜在再载灾该改盖海开凯踹害摆踩态卖哉怪还',
  // -ei (灰韵)
  ei: '北背杯被悲飞肥废费给类雷累泪美没每妹内贼追醉嘴对回水碎鬼为吹睡推锤',
  // -ao (豪韵)
  ao: '保宝抱报暴包饱草操好号毛貌闹脑高告搞郊交叫骄教觉笑小晓孝校照猫槽罩跑考老爆妖嫖漂',
  // -ou (尤韵)
  ou: '不否走奏头投透收手守受售搜某楼漏流留刘留牛留偶口扣后厚候构狗够久旧酒咎九救揍抽吼悠就修求',
  // -an (寒韵)
  an: '安岸案三山闪扇善单担但旦弹但谈坛炭难看砍抗安暗按办半伴判斩烂碗喊玩赞',
  // -en (痕韵)
  en: '本笨分坟粉份门闷们人忍认任申神慎深生甚什身森审审身啃沉喷',
  // -ang (江韵)
  ang: '长场常唱厂上当党挡荡刚港光逛黄行航将江讲匠帮邦旁忙忘王往望网亡杨阳样让丧扛香方乡装徨相亮抢',
  // -eng (庚韵)
  eng: '冯彭朋等灯能成承城诚程登冷僧风丰封峰冰兵冰冰冻冻讽',
  // -ong (东韵)
  ong: '东冬动同童铜痛通统总从冲虫崇松送宋公共工功红宏鸿洪轰空孔控懂中钟终种重用',
  // -ang/eng/ing — separate group for -ing (青韵)
  ing: '丁定听亭停庭萍平瓶兵冰名命明命星行星醒心心心情景京经精境境镜冷赢影金林烬',
  // -an/-ian merged into ian-special when needed
  ian: '边变面眠年念千前钱浅天田填见现县线点店电电念见间健剑减简仙脸辫娟怨悬卷',
  // -un (谆韵)
  un: '昏婚混滚棍论轮文闻问温存村寸蹲运军',
  // -üe (月韵)
  ue: '月穴雪血缺约略觉决绝学',
  // -ie (叠韵)
  ie: '贴界铁灭叠蝶别接街节劣烈裂',
  // -uo (戈韵)
  uo: '波多罗落作做错过国哥说脱拖躲所我锅火伙或墨哦戳',
};
